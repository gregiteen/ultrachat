...
DROP FUNCTION IF EXISTS ensure_threads_table();
DROP FUNCTION IF EXISTS ensure_messages_table();
DROP FUNCTION IF EXISTS reorder_threads(UUID);
...
ALTER FUNCTION ensure_threads_table() SET "pgrst.select" = 'id';
ALTER FUNCTION ensure_messages_table() SET "pgrst.select" = '';
ALTER FUNCTION reorder_threads(UUID) SET "pgrst.select" = '';